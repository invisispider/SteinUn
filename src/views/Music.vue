...
<template>
	<div id="bodyMain">
		...
		<h1 class="glow double-width">Holistic Music Lessons <br>with<br> Adam Loewen</h1>
		...
		<h3>I am currently booking:</h3>
		<h4>Remote online sessions</h4>
		<h4>In-home private and group lessons around Missoula, MT.</h4>
		<h4>My rates are generally
			$30 per half hour, including lesson prep but not including travel
			costs or materials.
		</h4>
		<h4>
		...
		<h3>Master music reading, theory, and vocabulary.</h3>
		<h3>Develop multiple intelligences and social skills.</h3>
		<h3>Positive attitude, self-esteem, and confidence.</h3>
		<h3>Emotional and artistic expression.</h3>
		<h3>Performances connect and enliven community.</h3>

		<h2 class="double-width">Skills</h2>
		<h3>Critical awareness and goal-orientation.</h3>
		<h3>Work closely with personal aims and ambitions.</h3>
		<h3>Work ethic and practice scheduling</h3>
		<h3>Breathing, posture and self awareness</h3>
		...
		<h2>Read about me in
			<a href="https://www.bigrapidsnews.com/news/article/evart-music-teacher-provides-osceola-county-fun-17741370.php"
				target="_blank">this article</a> from Big Rapids News.
		</h2>
		<h4>For six years, I taught as staff with Vancouver Music Academy, My Voice Music
		...
		<h4>I studied music, history, theory, and trumpet in college and played
			in classical, jazz, and pop bands for 20 years.</h4>
		<h4>I have written and recorded over
		...
		<div class="testimonials">
			<div class="testimonial">
				Our daughter has made great progress with piano under Adam's
			...
			<!-- <img class="kid-image" src="@/assets/img/kidpiano2.jpg" /> -->
			<img class="kid-image" src="@/assets/img/kidguitar.jpg" />
			<img class="kid-image" src="@/assets/img/paintpiano.jpg" />
			<!-- <img class="kid-image" src="@/assets/img/kidpiano3.jpg" /> -->
			<div class="testimonial">
		...
		<h2>Watch a playlist of cover songs and original home recordings.
			<a href="https://www.youtube.com/watch?v=j4BOaxU6zvk&list=PL-HrctEZpo50_xIks89Gi_2TA__wYh00l"
				target="_blank">ThousandPlus Playlist</a>
		</h2>
		<h2>Read about Adam's rock band and see performance videos:
			<RouterLink to="Videos">
				Stein unLimited Video Archive.
			</RouterLink>
		</h2>
	</div>
</template>
