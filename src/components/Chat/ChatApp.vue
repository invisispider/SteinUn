...
export default {
	...
	methods: {
		...
		async deleteRoom(roomId) {
			...
			if (
				room.users.find(user => user._id !== '9zPT6STYcKg5g3lAnNbTPQzdXBz2')
			) {
				return alert('I control the chats around here buster')
			}
