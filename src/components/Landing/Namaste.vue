...
<template>
    <div>
        ...
        <p><b>Instructions:</b><br>
            ...
            Select color theme on the top right.</p>
        ...
        <p><RouterLink to="/landing/Calendar">Calendar</RouterLink></p>
        <p><RouterLink to="/landing/IntegralTheory">IntegralTheory</RouterLink></p>
        <p><RouterLink to="/landing/Beacon">Beacon</RouterLink></p>
        <p><RouterLink to="/landing/Technomancy">Technomancy</RouterLink></p>
        <br>
        <h3>Site Features:</h3>
        <!-- <h4>My Treasures:</h4> -->
